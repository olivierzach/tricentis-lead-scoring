...
Next, send traffic to the app
    ...
    - app grabs the POST request, scales the data, scores the data then returns the score in JSON format
...
df_test = joblib.load('app/model_assets/gbm_model_x_test_for_flask.sav')
